...
run;quit;
 ...
 pxx_015annXlsP03<-read.xlsx("c:/pxx/xls/QM_PD1003_NEW_STATE.xlsx",1,colClasses=rep("character",29),stringsAsFactors=FALSE);
 rc<- dbWriteTable(conn,"pxx_015annXlsP03",pxx_015annXlsP03);
');
